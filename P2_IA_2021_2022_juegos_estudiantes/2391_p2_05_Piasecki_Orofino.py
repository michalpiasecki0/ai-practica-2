...
class Solution2(StudentHeuristic):
  def get_name(self) -> str:
    return "count_both_pieces_possible_catches"
  def evaluation_function(self, state: TwoPlayerGameState) -> float:
      """
      ...
      n_pieces_to_catch = count_how_many_enemies_could_you_catch(state=state, enemy_positions=enemy_positions,
...
def check_if_you_can_catch_this_point(x: int, y: int, state: TwoPlayerGameState, all_possible: list,
                                      player_sign) -> bool:
  """
...
def count_how_many_enemies_could_you_catch(state: TwoPlayerGameState, enemy_positions: list, possible_positions: list,
                                           player_sign: str) -> float:
  """
